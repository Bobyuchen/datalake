...
# 讀取 JSON 文件
with open('C:/Users/ASUS/Desktop/work/datalake/dbt-omop/FHIR_rowdata/twpas_output_transaction_20240813.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
# cur.execute('DROP SCHEMA IF EXISTS iceberg.ifhir')
